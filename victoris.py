...
# Heuristic Tables
######################################################
heuristic_table12x12 = [
    [100,   0,  10,   8,   6,   6,   6,   6,   8,  10,   0, 100],
    [  0,   0,   8,   4,   3,   3,   3,   3,   4,   8,   0,   0],
    [ 10,   8,   3,   3,   2,   2,   2,   2,   3,   3,   8,  10],
    [  8,   4,   3,   2,   1,   1,   1,   1,   2,   3,   4,   8],
    [  6,   3,   2,   1,   3,   3,   3,   3,   1,   2,   3,   6],
    [  6,   3,   2,   1,   3,   4,   4,   3,   1,   2,   3,   6],
    [  6,   3,   2,   1,   3,   4,   4,   3,   1,   2,   3,   6],
    [  6,   3,   2,   1,   3,   3,   3,   3,   1,   2,   3,   6],
    [  8,   4,   3,   2,   1,   1,   1,   1,   2,   3,   4,   8],
    [ 10,   8,   3,   3,   2,   2,   2,   2,   3,   3,   8,  10],
...
def get_move(board_size, board_state, turn,
    ...
    time_left = time_left / 1000.0
    opponent_time_left = opponent_time_left / 1000.0
